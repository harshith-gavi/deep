...
# create dataloaders
shd_train = DataLoader(train_ds, shuffle=True, batch_size=args.batch_size)
shd_test = DataLoader(test_ds, shuffle=False, batch_size=args.batch_size)
...
for _ in range(1, 2):
    ...
    for batch in enumerate(shd_train):
        inputs, labels = batch
