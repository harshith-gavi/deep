...
class LSNN(nn.Module):
    def __init__(self):
        ...
        self.l2_T_adp = nn.Linear(20, 20)
        self.l1_T_m = nn.Linear(100, 100)           # T_m
        self.l2_T_m = nn.Linear(20, 20)
        ...
        nn.init.constant_(self.l2_T_adp.bias,-5.)
        nn.init.constant_(self.l2_T_m.bias,-5.)
    ...
    def forward(self, x_t):
        ...
        L2 = self.l2(L1)
        T_m = self.act(self.l2_T_m(L2 + self.u_t))
        T_adp = self.act(self.l2_T_adp(L2 + self.b_t))
